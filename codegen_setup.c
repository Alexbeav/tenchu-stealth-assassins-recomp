...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Tenchu Stealth Assassins",
    .project_root_env = "TENCHU_STEALTH_ASSASSINS_RECOMP_PROJECT_ROOT",
    .build_dir_env = "TENCHU_STEALTH_ASSASSINS_RECOMP_BUILD_DIR",
    .force_setup_env = "TENCHU_STEALTH_ASSASSINS_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_007.06_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Tenchu_Stealth_Assassins__Recompiled",
    .prepare_note =
