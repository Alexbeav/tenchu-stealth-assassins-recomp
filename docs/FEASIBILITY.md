# Tenchu: Stealth Assassins feasibility binding

## Identity

- Title and region: Tenchu: Stealth Assassins, USA.
- Serial: SLUS-00706.
- Source executable path: `disc/SLUS_007.06`.
- Load address: `0x80011000`.
- Entry point: `0x8001A578`.
- Source disc binding: `disc/Tenchu - Stealth Assassins (USA) (Rev 1).cue`.
...
The clean source commit is `dfb7773fac776bb0337787a1f8ebf2560258d24a`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 548 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `dfb7773fac776bb0337787a1f8ebf2560258d24a`.
- Portfolio `tenchu-stealth-assassins/BUILDINFO.json`.
- Portfolio `tenchu-stealth-assassins/RECEIPT.md`.
